...
\title{Using the BridgeDbR package for identifier mapping}
\author{
  Egon Willighagen
}
\date{\today}
...
Questions can be directed to the BridgeDb Google Group at \url{https://groups.google.com/forum/#!forum/bridgedb-discuss}.
...
\begin{itemize}
\item Genes, Transcripts, and Proteins: \url{http://bridgedb.org/data/gene_database/}
\item Metabolites: \url{http://bridgedb.org/data/gene_database/}
\item Gene Variants: \url{http://bridgedb.org/data/variant/}
\end{itemize}
